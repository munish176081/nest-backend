...
exports.configConfiguration = exports.configValidationSchema = void 0;
...
var EmailServiceType;
(function (EmailServiceType) {
    EmailServiceType["Postmark"] = "postmark";
    EmailServiceType["SMTP"] = "smtp";
    EmailServiceType["Gmail"] = "gmail";
...
exports.configValidationSchema = Joi.object({
    ...
    OAUTH_TIMEOUT: Joi.number().default(30000),
