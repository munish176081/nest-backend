...
export declare class AuthService {
    ...
    private cache;
    constructor(externalAuthAccountRepo: Repository<ExternalAuthAccount>, usersService: UsersService, activityLogsService: ActivityLogsService, emailService: EmailService, configService: ConfigService, otpService: OtpService, dataSource: DataSource);
