...
export declare class AuthService {
    ...
    private cache;
    constructor(externalAuthAccountRepo: Repository<ExternalAuthAccount>, usersService: UsersService, emailService: EmailService, configService: ConfigService, otpService: OtpService);
    ...
    signUp(signupBody: SignupDto, ip?: string): Promise<User>;
    requestEmailVerify(email: string): Promise<{
        message: string;
    }>;
