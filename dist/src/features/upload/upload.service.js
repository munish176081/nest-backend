...
let UploadService = UploadService_1 = class UploadService {
    ...
    validateFileSize(fileSize, fileType) {
        const maxSizes = {
            [request_upload_url_dto_1.FileType.IMAGE]: 15 * 1024 * 1024,
            [request_upload_url_dto_1.FileType.BREED_IMAGE]: 15 * 1024 * 1024,
            [request_upload_url_dto_1.FileType.BREED_TYPE_IMAGE]: 15 * 1024 * 1024,
            [request_upload_url_dto_1.FileType.VIDEO]: 500 * 1024 * 1024,
            [request_upload_url_dto_1.FileType.DOCUMENT]: 25 * 1024 * 1024,
        };
