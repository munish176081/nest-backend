            ...
            typeorm_1.TypeOrmModule.forRootAsync({
                ...
                useFactory: (configService) => {
                    ...
                    return {
                        ...
                        synchronize: true,
                        entities: [external_auth_accounts_entity_1.ExternalAuthAccount, account_entity_1.User, upload_entity_1.Upload, listing_entity_1.Listing, breed_entity_1.Breed, conversation_entity_1.Conversation, message_entity_1.Message, participant_entity_1.Participant, meeting_entity_1.Meeting, user_calendar_tokens_entity_1.UserCalendarTokens, wishlist_entity_1.Wishlist, blog_post_entity_1.BlogPost, blog_category_entity_1.BlogCategory],
