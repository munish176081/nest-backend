            ...
            typeorm_1.TypeOrmModule.forRootAsync({
                ...
                useFactory: (configService) => {
                    ...
                    return {
                        ...
                        synchronize: true,
                        entities: [external_auth_accounts_entity_1.ExternalAuthAccount, account_entity_1.User, upload_entity_1.Upload, listing_entity_1.Listing, breed_entity_1.Breed],
